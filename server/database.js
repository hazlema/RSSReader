		...
		try {
			...
			if (reactionCount.count === 0) {
				...
				const defaultReactions = [
					{ type: 'Neutral', prompt: 'Write a pithy 2-sentence response to the story at url: [{url}]. Keep it human-sounding, Neutral in tone, ensuring there is subtle humor or a pun baked in, and throw in emojis as needed. Please don\'t use any interjections.' },
					{ type: 'Amused', prompt: 'Write a pithy 2-sentence response to the story at url: [{url}]. Keep it human-sounding, Amused in tone, ensuring there is subtle humor or a pun baked in, and throw in emojis as needed. Please don\'t use any interjections.' },
					{ type: 'Sarcastic', prompt: 'Write a pithy 2-sentence response to the story at url: [{url}]. Keep it human-sounding, Sarcastic in tone, ensuring there is subtle humor or a pun baked in, and throw in emojis as needed. Please don\'t use any interjections.' },
					{ type: 'Excited', prompt: 'Write a pithy 2-sentence response to the story at url: [{url}]. Keep it human-sounding, Excited in tone, ensuring there is subtle humor or a pun baked in, and throw in emojis as needed. Please don\'t use any interjections.' },
					{ type: 'Surprised', prompt: 'Write a pithy 2-sentence response to the story at url: [{url}]. Keep it human-sounding, Surprised in tone, ensuring there is subtle humor or a pun baked in, and throw in emojis as needed. Please don\'t use any interjections.' },
					{ type: 'Empathetic', prompt: 'Write a pithy 2-sentence response to the story at url: [{url}]. Keep it human-sounding, Empathetic in tone, ensuring there is subtle humor or a pun baked in, and throw in emojis as needed. Please don\'t use any interjections.' },
					{ type: 'Thoughtful', prompt: 'Write a pithy 2-sentence response to the story at url: [{url}]. Keep it human-sounding, Thoughtful in tone, ensuring there is subtle humor or a pun baked in, and throw in emojis as needed. Please don\'t use any interjections.' },
					{ type: 'Disappointed', prompt: 'Write a pithy 2-sentence response to the story at url: [{url}]. Keep it human-sounding, Disappointed in tone, ensuring there is subtle humor or a pun baked in, and throw in emojis as needed. Please don\'t use any interjections.' },
					{ type: 'Outraged', prompt: 'Write a pithy 2-sentence response to the story at url: [{url}]. Keep it human-sounding, Outraged in tone, ensuring there is subtle humor or a pun baked in, and throw in emojis as needed. Please don\'t use any interjections.' }
				];
